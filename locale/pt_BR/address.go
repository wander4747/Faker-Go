...
var Addresses = map[string][]string{
	...
	"secondary_address": {
		"Bloco #", "Ap. #", "#º Andar", "Apto #", "Casa #",
	},
	"street_name": {
		"Santo Antonio", "Brazil", "São Pedro", "Tiradentes", "Santa Luzia", "Bahia", "Duque de Caxias", "Santos Dumont",
		"Boa vista", "São Luiz", "Santa Rita", "Paraíba", "Alagoas", "Primeiro de maio", "Dom Pedro II",
	},
	"street_prefix": {
		"Av.", "Avenida", "R.", "Rua", "Rodovia",
	},
	"neighborhood": {
		"Sagrada Família", "Buritis", "Padre Eustáquio", "Lindéia", "Coqueiros", "Santa Mônica", "Céu Azul", "Serra", "Sion",
		"Lourdes", "Ouro Preto", "Castelo", "Planalto", "Centro", "Pampulha", "Glória", "Prado", "Camargos", "União",
	},
}
